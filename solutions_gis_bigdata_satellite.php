		...
		<div class="am-container-1">
			<div class="toppic-title left">
				<i class="am-icon-lightbulb-o toppic-title-i"></i> <span
					class="toppic-title-span">卫星倾斜</span>
				<p>Satellite Tilt</p>
			</div>
			<div class="right toppic-progress">
				...
				<i class=" am-icon-arrow-circle-right w-white"></i> <span>
				<a href="solutions_gis_bigdata_satellite.php" class="w-white">卫星倾斜</a></span>
			</div>
		</div>
	</div>
...
<!-- 				<a class="am-btn am-btn-default">
	...
	<div data-am-widget="tabs"class="am-tabs am-tabs-d2 ">
      ...
      <ul class="am-tabs-nav am-cf solutions-tabs-ul " id="tabpanel_main">
           <li class="am-active solutions-tabs-ul-li1"><a href="[data-tab-panel-0]" ><i class=" am-primary am-icon-shield "></i><span>模型示例</span></a></li>
           <li class="solutions-tabs-ul-li2"><a href="[data-tab-panel-1]"><i class=" am-icon-mobile-phone mobile-phone"></i><span>精度展示</span></a></li> 
           <li class="solutions-tabs-ul-li3"><a href="[data-tab-panel-2]" ><i class=" am-icon-desktop"></i><span>效能与优势</span></a></li> 
           <li class="solutions-tabs-ul-li4"><a href="[data-tab-panel-3]"><i class=" am-icon-mobile-phone mobile-phone"></i><span>行业应用</span></a></li>
