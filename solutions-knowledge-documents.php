...
<head lang="en">
  ...
  <script type="text/javascript">   
     $(function(){ //等效于$(document).ready(function(){})或者 jQuery(function($){ })   ，防止文档在完全加载（就绪）之前运行 jQuery 代码
	     ...
	     var doc=new Array();
	     for(var i=0;i<9;i++){
	       doc[i] = create_img_tables("发布时间：2016-09-12","“你的旅行，是什么颜色？” 晒照片，换北欧梦幻极光之旅！","assets/img/a1.png",
    ...
    function create_img_tables(date,title,imgurl,txt,buttonfunction,qqnum,weixinnum,githubnum){
    	
		var divtop =     $("<div class=\"am-u-sm-12 am-u-md-6 am-u-lg-4\">");
		...
		contentdetail[2]=$("<a href=\"javascript:;\" class=\"tpl-table-images-content-i\">");
...
<div class="toppic">
	 ...
	 <div class="toppic-title left">
			...
			<span class="toppic-title-span">CAE资料库</span>
			<p>Konwledge cloud</p>
		</div>
		<div class="right toppic-progress">
			...
			<i class=" am-icon-arrow-circle-right w-white"></i>
			<span><a href="solutions-knowledge-documents.php" class="w-white">CAE资料库</a></span>
		</div>
	</div>
</div>
...
<div class=" " >	
	<div class="part-title part-title-mar">
			...
			<span class="part-title-span">资料列表</span>
			<p>Documents List</p>
			</a>
	</div>
