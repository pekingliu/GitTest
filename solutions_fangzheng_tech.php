		...
		<div class="am-container-1">
			<div class="toppic-title left">
				<i class="am-icon-lightbulb-o toppic-title-i"></i> <span
					class="toppic-title-span">仿真服务</span>
				<p></p>
			</div>
			<div class="right toppic-progress">
				<span><a href="solutions.php" class="w-white">核心业务</a></span> 
				<i class=" am-icon-arrow-circle-right w-white"></i> <span>
				<a href="solutions.php" class="w-white">仿真云</a></span>
				<i class=" am-icon-arrow-circle-right w-white"></i> <span>
				<a href="solutions_fangzheng_tech.php" class="w-white">仿真服务</a></span>
			</div>
		</div>
	</div>
...
<!-- 				<a class="am-btn am-btn-default">
	...
	<div data-am-widget="tabs"class="am-tabs am-tabs-d2 ">
      ...
      <ul class="am-tabs-nav am-cf solutions-tabs-ul " id="tabpanel_main">
           <li class="am-active solutions-tabs-ul-li1"><a href="[data-tab-panel-0]" ><i class=" am-primary am-icon-shield "></i><span>服务介绍</span></a></li>
           <li class="solutions-tabs-ul-li2"><a href="[data-tab-panel-1]"><i class=" am-icon-mobile-phone mobile-phone"></i><span>专业领域</span></a></li> 
           <li class="solutions-tabs-ul-li3"><a href="[data-tab-panel-2]" ><i class=" am-icon-desktop"></i><span>行业案例</span></a></li> 
           <li class="solutions-tabs-ul-li4"><a href="[data-tab-panel-3]"><i class=" am-icon-mobile-phone mobile-phone"></i><span>定制开发</span></a></li>
...
<!-- 												<h3 class="am-gallery-title">复杂电磁环境数值模拟</h3> -->
												<div class="am-gallery-desc">缸盖强度分析</div></a>
										</div>
									</li>
																		<li>
										<div class="am-gallery-item">
...
<!-- 												<h3 class="am-gallery-title">复杂电磁环境数值模拟</h3> -->
												<div class="am-gallery-desc">减速器强度分析</div></a>
										</div>
									</li>
									<li>
										<div class="am-gallery-item">
...
<!-- 												<h3 class="am-gallery-title">复杂电磁环境数值模拟</h3> -->
												<div class="am-gallery-desc">结构刚度分析  STI Analysis</div></a>
										</div>
									</li>
							</ul>        			
            		</div>            		 
            			    ...
            			    <ul data-am-widget="gallery" 
								class="am-gallery am-avg-sm-1  am-avg-md-2 am-avg-lg-4 am-gallery-imgbordered"
									...
									<li>
										<div class="am-gallery-item">
											<a
												href="img/solutions_fangzhengyun/图片13.png"
												title="天线综合布局设计与优化">
												<img src="img/solutions_fangzhengyun/图片13.png"	alt="" />
<!-- 												<h3 class="am-gallery-title">汽车发动机舱温度场分析</h3> -->
												<div class="am-gallery-desc">汽车发动机舱温度场分析</div></a>
										</div>
									</li>
									<li>
										<div class="am-gallery-item">
											<a
												href="img/solutions_fangzhengyun/图片14.png"
												title="天线综合布局设计与优化">
												<img src="img/solutions_fangzhengyun/图片14.png"	alt="" />
<!-- 												<h3 class="am-gallery-title">复杂电磁环境数值模拟</h3> -->
												<div class="am-gallery-desc">汽车外流场分析</div></a>
										</div>
									</li>
																		<li>
										<div class="am-gallery-item">
											<a
												href="img/solutions_fangzhengyun/图片15.png"
												title="天线综合布局设计与优化">
												<img src="img/solutions_fangzhengyun/图片15.png"	alt="" />
<!-- 												<h3 class="am-gallery-title">复杂电磁环境数值模拟</h3> -->
												<div class="am-gallery-desc">柴油机缸内喷雾燃烧过程分析</div></a>
										</div>
									</li>
									<li>
										<div class="am-gallery-item">
											<a
												href="img/solutions_fangzhengyun/图片16.png"
												title="天线综合布局设计与优化">
												<img src="img/solutions_fangzhengyun/图片16.png"	alt="" />
<!-- 												<h3 class="am-gallery-title">复杂电磁环境数值模拟</h3> -->
												<div class="am-gallery-desc">列车隧道内交会过程分析</div></a>
										</div>
									</li>
							</ul>        			
            		</div>            		 
