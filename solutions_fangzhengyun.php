		...
		<div class="am-container-1">
			<div class="toppic-title left">
				<i class="am-icon-lightbulb-o toppic-title-i"></i> <span
					class="toppic-title-span">仿真云平台</span>
				<p>Design Cloud</p>
			</div>
			<div class="right toppic-progress">
				<span><a href="solutions.php" class="w-white">核心业务</a></span> 
				<i class=" am-icon-arrow-circle-right w-white"></i> <span>
				<a href="solutions.php" class="w-white">超链仿真云</a></span>
				<i class=" am-icon-arrow-circle-right w-white"></i> <span>
				<a href="solutions_fangzhengyun.php" class="w-white">仿真云平台</a></span>
			</div>
		</div>
	</div>
...
-->	
				...
				<a class="am-btn am-btn-default" target="_new" href="https://vpn2.nsccjn.cn/por/login_psw.csp?rnd=0.5448416581701686#https%3A%2F%2Fvpn2.nsccjn.cn%2F"> <i
...
<!-- 				<a class="am-btn am-btn-default">
	...
	<div data-am-widget="tabs"class="am-tabs am-tabs-d2 ">
      ...
      <ul class="am-tabs-nav am-cf solutions-tabs-ul " id="tabpanel_main">
           ...
           <li class="solutions-tabs-ul-li3"><a href="[data-tab-panel-2]" ><i class=" am-icon-desktop"></i><span>用户伙伴</span></a></li> 
...
<!--             			<p>具备丰富的后处理能力，可获得矢量图、流线、动画等；可在多个计算结果之间对比数据;能进行图形绘制；具备标注能力（色标、二维和三维文字说明）；可以JPEG、PNG、BMP、PPM、VRML等多种格式输出图形。</p> -->
            			<br>
            			<img src="img/solutions_fangzhengyun/software.png" class="am-img-responsive" alt=""/>
            		</div>
