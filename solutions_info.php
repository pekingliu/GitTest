...
<!--     <div class=" am-collapse am-topbar-collapse" role="search"> -->
 ...
 <li ><a href="index.php">首页</a></li>     
        ...
        <ul class="am-dropdown-content">
          ...
          <li  class="hw-menu-active"><a href="solutions_info.php"><span class="am-icon-user am-icon-fw am-primary"></span> IT技术服务</a></li>      <li class="am-divider"></li>
...
<!-- 				<a class="am-btn am-btn-default">
	...
	<div data-am-widget="tabs"class="am-tabs am-tabs-d2 ">
      ...
      <ul class="am-tabs-nav am-cf solutions-tabs-ul " id="tabpanel_main">
           <li class="am-active solutions-tabs-ul-li1"><a href="[data-tab-panel-0]" ><i class=" am-primary am-icon-shield "></i><span>运维托管服务</span></a></li>
           <li class="solutions-tabs-ul-li2"><a href="[data-tab-panel-1]"><i class=" am-icon-mobile-phone mobile-phone"></i><span>系统集成业务</span></a></li> 
           <li class="solutions-tabs-ul-li3"><a href="[data-tab-panel-2]" ><i class=" am-icon-desktop"></i><span>科研项目合作</span></a></li> 
           <li class="solutions-tabs-ul-li4"><a href="[data-tab-panel-3]"><i class=" am-icon-mobile-phone mobile-phone"></i><span>技术培训服务</span></a></li>
          	...
          	<ul class=" solutions-content-ul">
            	<li class="am-u-sm-12 am-u-md-6 am-u-lg-4">
            		...
            		<div class="am-u-sm-12 am-u-md-12 am-u-lg-9 solution-tabs-words">
            			<h5>服务介绍</h5>
            			<p>根据客户需求，为客户建立安全运维机制，实现7x24集中监控以及7x24小时现场维护值守。</p>
            	...
            	<li class="am-u-sm-12 am-u-md-6 am-u-lg-4">
            		...
            		<div class="am-u-sm-12 am-u-md-12 am-u-lg-9 solution-tabs-words">
            			<h5>业务领域</h5>
            			<p>信息化机房范围内的计算、存储、网络、配电、制冷等配套软硬件设施.</p>
            	...
            	<li class="am-u-sm-12 am-u-md-6 am-u-lg-4">
            		...
            		<div class="am-u-sm-12 am-u-md-12 am-u-lg-9 solution-tabs-words">
            			<h5>服务案例</h5>
							<p>国家超级计算济南中心<br> 齐鲁软件园发展中心<br> 青岛海洋实验室机房 <br>人工智能大数据平台 <br>医疗大数据机房。</p>
          ...
          <div data-tab-panel-1 class="am-tab-panel" >
          	<ul class=" solutions-content-ul">
            	<li class="am-u-sm-12 am-u-md-6 am-u-lg-12">
            		...
            		<div
								class="am-u-sm-12 am-u-md-12 am-u-lg-3 solution-tabs-img">
								<img src="img/product_img/ANSYS-Structures/结构分析.jpg" />
							</div>
							<div class="am-u-sm-12 am-u-md-12 am-u-lg-9 solution-tabs-words">
            			<h5>服务介绍</h5>
            			<p>根据客户自身需求与国家相关设计实施标准规范，为客户量身定制机房全生命周期技术咨询服务方案与高质量的机房专业设备</p>
            		</div>
            		</a> 
            	</li>
            	<li class="am-u-sm-12 am-u-md-6 am-u-lg-12">
            		...
            		<div class="am-u-sm-12 am-u-md-12 am-u-lg-9 solution-tabs-words">
            			<h5>业务领域</h5>
            			<p>机房全生命周期技术咨询服务，提供计算、存储、网络、安全、配电、制冷等相关系统的设计规划咨询与设备选型等技术支持.</p>
            		</div>
            		</a> 
            	</li>
            	<li class="am-u-sm-12 am-u-md-6 am-u-lg-12">
            		...
            		<div class="am-u-sm-12 am-u-md-12 am-u-lg-9 solution-tabs-words">
            			<h5>服务案例</h5>
						<p>齐鲁工业大学 中国石油大学<br> 山东建筑大学 <br>山东师范大学 <br>青岛海洋实验室<br> 国家超级计算济南中心<br>
									齐鲁软件园发展中心<br> 青岛海洋实验室机房<br> 人工智能大数据平台<br> 医疗大数据机房.</p>
							</div>
            		</a> 
            	</li>
           ...
           <div data-tab-panel-2 class="am-tab-panel">
          	<ul class=" solutions-content-ul">
            	<li class="am-u-sm-12 am-u-md-6 am-u-lg-4">
            		...
            		<div class="am-u-sm-12 am-u-md-12 am-u-lg-9 solution-tabs-words">
            			<h5>服务介绍</h5>
            			<p>根据客户国产众核下的软件移植和并行优化等需求，进行相关科研项目开发合作服务。</p>
            		</div>
            		</a> 
            	</li>
            	<li class="am-u-sm-12 am-u-md-6 am-u-lg-4">
            		...
            		<div class="am-u-sm-12 am-u-md-12 am-u-lg-9 solution-tabs-words">
            			<h5>业务领域</h5>
						<p>国产众核下的软件移植和并行优化<br> 大数据平台运营与搭建<br> 数据备份<br> 小型HPC集群搭建 <br>微信公众号开发</p>
					 </div>
            		</a> 
            	</li>
            	<li class="am-u-sm-12 am-u-md-6 am-u-lg-4">
            		...
            		<div class="am-u-sm-12 am-u-md-12 am-u-lg-9 solution-tabs-words">
            			<h5>服务案例</h5>
            			<p>主要针对企事业单位、各大研究院校、主要是参与CESM海洋气候、E级验证机研制、国家超级计算济南中心科研开发、青岛海洋实验室机房E级计算机研制。</p>
            		</div>
            		</a> 
            	</li>
          ...
          <div data-tab-panel-3 class="am-tab-panel" >
          	<ul class=" solutions-content-ul">
            	<li class="am-u-sm-12 am-u-md-6 am-u-lg-12">
            		...
            		<div class="am-u-sm-12 am-u-md-12 am-u-lg-9 solution-tabs-words">
            			<h5>服务介绍</h5>
            			<p>根据客户需求对外提供软硬件的技术培训，主要包括：shell编程、liunx基础应用、并行计算方法、软件开发等并行计算技术培训；科学计算和工程计算应用软件使用培训；机房各系统运维管理技术培训等。</p>
            		</div>
            		</a> 
            	</li>
            	<li class="am-u-sm-12 am-u-md-6 am-u-lg-12">
            		...
            		<div class="am-u-sm-12 am-u-md-12 am-u-lg-9 solution-tabs-words">
            			<h5>业务领域</h5>
            			<p>shell编程、liunx基础应用、并行计算方法、软件开发等并行计算技术培训<br>科学计算和工程计算应用软件使用培训<br>机房各系统运维管理技术培训等
            			</p>
            		</div>
            		</a> 
            	</li>
            	<li class="am-u-sm-12 am-u-md-6 am-u-lg-12">
            		...
            		<div class="am-u-sm-12 am-u-md-12 am-u-lg-9 solution-tabs-words">
            			<h5>服务案例</h5>
            			<p>主要针对企事业单位、各大研究院校、现阶段主要是对国家超级计算济南中心、齐鲁软件园发展中心、青岛海洋实验室机房、人工智能大数据平台、医疗大数据机房，提供技术培训与咨询服务。
            			</p>
            		</div>
            		</a> 
            	</li>
